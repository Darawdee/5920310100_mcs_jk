...
//กรณีมี Error เกิดขึ้น
	if ($mysqli->connect_error) {
		...
		$get_data = $mysqli->query("SELECT * FROM chart4");
...
<p></p>
				...
				<?php
					foreach($result as $result_tb){
						echo"<tr>";
							...
							echo "<td>".$result_tb['P1']."</td>";
							echo "<td>".$result_tb['Pt']."</td>";
							echo "<td>".$result_tb['Aj']."</td>";
							echo "<td>".$result_tb['inpeple']."</td>";
							echo "<td>".$result_tb['outpeple']."</td>";
	...
	$(function () {
		...
		$('#container').highcharts({
			...
			title: {
				text: 'ข้อมูลการยืมทรัพยากรสารสนเทศของผู้ใช้บริการ'
			},
			yAxis: {
				allowDecimals: false,
				title: {
