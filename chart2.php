...
//กรณีมี Error เกิดขึ้น
	if ($mysqli->connect_error) {
		...
		//เรียกข้อมูลจาก ตาราง chart2 
		$get_data = $mysqli->query("SELECT * FROM chart2");
...
<p></p>
				...
				<?php
					foreach($result as $result_tb){
						echo"<tr>";
							...
							echo "<td>".$result_tb['fac1']."</td>";
							echo "<td>".$result_tb['fac2']."</td>";
							echo "<td>".$result_tb['fac3']."</td>";
							echo "<td>".$result_tb['fac4']."</td>";
							echo "<td>".$result_tb['fac5']."</td>";
							echo "<td>".$result_tb['fac6']."</td>";
							echo "<td>".$result_tb['fac7']."</td>";
							echo "<td>".$result_tb['fac8']."</td>";
							echo "<td>".$result_tb['fac9']."</td>";
	...
	$(function () {
		...
		$('#container').highcharts({
			...
			title: {
				text: 'ข้อมูลการยืมทรัพยากรสารสนเทศแต่ละคณะ ทั้ง 9 ปี'
			},
			yAxis: {
				allowDecimals: false,
				title: {
